...
> *Na tym samym urządzeniu — tak, i przeanalizowałem to. Wystarczy trzymać oko nieruchomo w punkcie fiksacji i wybierać uwagą, nie spojrzeniem; kamerka nie ma wtedy z czego odczytać wyboru, bo kierunek patrzenia jest przez cały czas ten sam. Kosztuje to zejście z czterdziestu celów do dwóch albo czterech i spadek dokładności — w 2004 zmierzono karę dwudziestu punktów procentowych, a w 2021 kodowanie fazowe dało 88% u osób bez treningu. Tego trybu nie zbudowałem: mierzę geometrię elektrody, a do pomiaru potrzebuję najsilniejszego dostępnego sygnału. Mam rozpisany warunek pomiarowy i wiem, ile by kosztował — jeżeli będzie pytanie, mogę pokazać plan.*
