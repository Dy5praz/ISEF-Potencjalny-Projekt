...
**Rozwiązanie: jedna opcja z siedmiu zabija zarzut o kamerkę, nie ruszając w projekcie niczego.** Dwie nałożone na siebie migające powierzchnie w jednym punkcie, wybierane uwagą przy nieruchomym oku (Tsinghua 2010, 72,6% przy dwóch klasach). **Kamerka nie ma wtedy czego mierzyć, bo nie ma dokąd patrzeć**, a moduł, elektrody, tor i metryka zostają nietknięte. Wpisane jako **E6**, 11–15 h razem z treningiem i programem bodźcowym.

**Kilka godzin później okazało się, że najlepszą opcję odrzuciłem błędnie.** Autor zapytał o kompromis, bo spadek do dwóch celów bolał. Sprawdzenie pokazało, że **uwaga utajona przestrzenna** — skreślona przeze mnie zdaniem „kamerka nadal działa" — **pokonuje kamerkę tak samo dobrze**, bo kamerka odczytuje kierunek patrzenia, a ten przy uwadze utajonej jest stały. Do tego skaluje się powyżej dwóch celów, nie wymaga trzydniowego treningu i ma nowszy wynik odniesienia: **88,4% u osób nieprzeszkolonych wobec 72,6% po treningu** (K-109). Przy okazji wyszła rzecz ogólniejsza: **liczba celów bije dokładność** — cztery cele przy 78% dają dwa razy więcej niż dwa przy 88%.

**Decyzja autora, ten sam dzień:** *„Szczerze, nie wiem. Zachowaj to w jakimś dokumencie, na razie zostajemy przy wersji podstawowej."* **P38 odłożone, nie odrzucone.** Projekt idzie z jednym trybem, sterowanym wzrokiem. Gotowy plan warunku leży w `05_STAN_WIEDZY.md` §7.6 z trzema wyzwalaczami powrotu, z których wiążący jest **31 III 2027** — ostatni moment, w którym scenę bez wzroku dałoby się nakręcić przed półfinałem.

`[wniosek]` **To jest pierwsza decyzja w tym projekcie podjęta w kształcie „odkładam z terminem", a nie „biorę albo odrzucam"** — i jest właściwa, bo E6 nie dzieli niczego ze ścieżką główną, więc odłożenie nie kosztuje nic poza czasem, a decyzja podjęta później zapadnie przy większej wiedzy: po E0 i po pierwszych własnych pomiarach.
