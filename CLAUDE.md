...
6. **`KOREKTY.md`** — rejestr błędów K-001…K-101. Dopisuj każdy nowy
...
**Najbliższe: P38** (decyzja o warunku E6 — tryb bez sterowania wzrokiem) · **P37** (nauka PCB od IX, zatwierdzone) · **P5** (używany Cyton do 30 IX) · **P11** (reanaliza zbioru 102-osobowego, za darmo) · **E0** (przesiew w X 2026 — najważniejszy punkt planu).
